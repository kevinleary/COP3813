$(function() {
  ...
  $newItemForm.on('submit', function(e) {       // When a new item is submitted
    ...
    if ('input:text' === null || text.length == 0)
    {
        e.stopImmediatePropagation();         //attempted to it to stop if nothing entered
        e.preventDefault();
        e.stopPropagation();
    }
    else
    {
      $list.append('<li>' + '#counter' + text + '</li>');      // Add item to end of the list
